...
// 			async : false,
	...
	function createTable(data) {
		...
		if (data.listAdminInfo == null || data.listAdminInfo.length == 0) {
			...
			for (var i = 0; i < data.listAdminInfo.length; i++) {
				...
				var row = "<tr>";
				row += "<td><span class=\"checkbox-w\" id=\"checkbox-w\"><label><input type=\"checkbox\" name=\"selectbox_"+i+"\" value=\""+data.listAdminInfo[i].ADMIN_ID+"\"></label></span></td>";
				row += "<td>12</td>";
	...
	function addPageNum(memCnt)
	{
		...
		var pageMaxNum = Math.ceil(memCnt/selectLimit)
...
<div class="result-wrap">
    ...
    <div class="btn-wrap">
        <a class="btn-type4" href="#none">Excel 다운로드</a>
    </div>
</div>
...
<table id="tbl-1" class="tbl-1">
	...
	<thead>
	    <tr>
	    	<th><span class="checkbox-w"><label><input type="checkbox"></label></span></th>
	        <th><span>번호</span></th>
	        <th><span>이름 </span></th>
	        <th><span>아이디</span></th>
